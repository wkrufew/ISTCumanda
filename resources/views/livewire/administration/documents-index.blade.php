                    ...
                    <div class="shadow overflow-hidden border-b border-gray-200 sm:rounded-lg">
                        <div class="py-4 px-6 flex">
                            <input wire:model="search" type="search" class="form-input flex-1 shadow-lg  rounded-full"
                                placeholder="Escriba el titulo de un documento...">
                            <a class="px-3 py-2 rounded-full bg-blue-600 text-white font-medium ml-2"
                                href="{{ route('administrador.documents.create') }}">Nuevo
                                Documento</a>
                        </div>
                                        ...
                                        <tr>
                                            <td class="px-3 py-3 whitespace-nowrap">
                                                <div class="flex items-center">
                                                    <div class="flex-shrink-0 h-10 w-auto flex items-center">
                                                        @isset($document->file)
                                                            <svg class="size-6 fill-verdeclaro"
                                            ...
                                            <td
                                                ...
                                                <a href="{{ route('administrador.documents.edit', $document) }}"
