<section>
            ...
            <div class="">
                @if ($requirement->id == $item->id)
                    <form wire:submit.prevent="update">
                        <input wire:model.live="editedName"
                            placeholder="Ingresa el nombre de un requerimiento del curso..."
    ...
    <article class="">
        <form wire:submit.prevent="store">
            <input placeholder="Ingresa el nombre de un requerimiento del curso..." wire:model="name"
