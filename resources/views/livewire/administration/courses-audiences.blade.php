<section>
            ...
            <div class="">
                @if ($audience->id == $item->id)
                    <form wire:submit.prevent="update">
                        <input wire:model.live="editedName" placeholder="Ingresa el nombre de una audiencia del curso..."
    ...
    <article class="">
        <form wire:submit.prevent="store">
            <input placeholder="Ingresa el nombre de una audiencia del curso..." wire:model="name"
