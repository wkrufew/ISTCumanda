<x-administrador-layout>
    ...
    <div class="p-6 bg-white rounded-lg mt-2">
        <h1 class="mb-4 text-center font-semibold text-lg">Generar Estudiante</h1>

        <form action="{{ route('administrador.students.store') }}" method="POST">
            @csrf
