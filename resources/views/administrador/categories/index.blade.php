<x-administrador-layout>
    <div class="bg-white shadow-md rounded-lg p-6 mb-6">
        <div class="flex justify-between items-center mb-4">
            ...
            <a href="{{ route('administrador.categories.create') }}"
                    ...
                    @forelse ($categories as $key => $category)
                        <tr class="border-b">
                            ...
                            <td class="px-4 py-2 flex justify-center space-x-2">
                                <a href="{{ route('administrador.categories.edit', $category) }}"
                                ...
                                <form action="{{ route('administrador.categories.destroy', $category) }}" method="POST"
                                    class="inline-block">
                                    @method('DELETE')
                                    @csrf
