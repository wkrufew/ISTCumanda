<x-administrador-layout>
    <div class="max-w-7xl mx-auto py-10 sm:px-6 lg:px-8">
        <div class="bg-white shadow-md rounded-lg p-6">
            <h2 class="text-2xl font-semibold text-gray-800 mb-6">Editar Periodo</h2>

            <form action="{{ route('administrador.periods.update', $period) }}" method="POST">
                @csrf
                @method('PUT')
                ...
                <div class="grid grid-cols-2 md:grid-cols-3 gap-4">
                    ...
                    <div class="mb-4">
                        ...
                        <input type="text" name="nombre" id="nombre"
                            ...
                            value="{{ old('nombre', $period->nombre) }}">
                        @error('nombre')
                ...
                <div class="grid grid-cols-2 gap-4">
                    ...
                    <div class="mb-4">
                        ...
                        <input type="date" name="registration_start_date" id="registration_start_date"
                            ...
                            value="{{ old('registration_start_date', $period->registration_start_date->format('Y-m-d')) }}">
                    ...
                    <div class="mb-4">
                        ...
                        <input type="date" name="registration_end_date" id="registration_end_date"
                            ...
                            value="{{ old('registration_end_date', $period->registration_end_date->format('Y-m-d')) }}">
